...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/segmen-operation/icons/gear_color.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboModules.addItem(icon3, "")
        icon4 = QIcon()
        icon4.addFile(u":/core/icons/segmenation_module.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboModules.addItem(icon4, "")
        icon5 = QIcon()
        icon5.addFile(u":/core/icons/3d_glasses.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboModules.addItem(icon5, "")
        icon6 = QIcon()
        icon6.addFile(u":/core/icons/volune.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboModules.addItem(icon6, "")
        ...
        self.comboModules.setMinimumSize(QSize(216, 32))
