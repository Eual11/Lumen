...
class Ui_segmentControl(object):
    def setupUi(self, segmentControl):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/segmen-operation/icons/cubes.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.reconMethod.addItem(icon3, "")
        icon4 = QIcon()
        icon4.addFile(u":/segmen-operation/icons/terahedron.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.reconMethod.addItem(icon4, "")
        icon5 = QIcon()
        icon5.addFile(u":/segmen-operation/icons/gray_grid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.reconMethod.addItem(icon5, "")
        icon6 = QIcon()
        icon6.addFile(u":/segmen-operation/icons/color_grid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.reconMethod.addItem(icon6, "")
    ...
    def retranslateUi(self, segmentControl):
        ...
        self.reconMethod.setItemText(2, QCoreApplication.translate("segmentControl", u"CPU Volume RayCasting", None))
        self.reconMethod.setItemText(3, QCoreApplication.translate("segmentControl", u"GPU Volume RayCasting", None))
